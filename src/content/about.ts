/**
 * LinkedIn About v3, paragraphs 1, 2 and 4, verbatim (live since 2026-09-24).
 */
...
/** Store numbers measured 2026-09-23. Re-measure on launch day. */
export const numbers: readonly { value: string; label: string }[] = [
    { value: "19", label: "years building software, since 2007" },
    { value: "100,000+", label: "installs on Google Play" },
    { value: "4.9", label: "App Store rating, from 731 ratings" },
